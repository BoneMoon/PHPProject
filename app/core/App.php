...
> Cria um array (pela divisão do URL pelo /)
  ...
  - Índice restantes: parâmetros do método
====================================================================== */
namespace app\core;
class App {
  private $controller;
  ...
  */
  private function parseURL() {
    ...
    // http://www.ipvc.pt/ecgm/ano3.php?uc=pw
...
http://localhost
http://localhost/brawler/ - invoca método index() do controlador Brawler (listagem de todos os Brawlers)
http://localhost/brawler/get/5 - invoca método get() do controlador Brawler (listagem de um Brawler)
